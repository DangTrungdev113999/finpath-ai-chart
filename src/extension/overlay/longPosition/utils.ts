...
export interface LongPositionStats {
  tpDiff: number
  slDiff: number
  tpPct: number
  slPct: number
...
export function calculateStats (
  ...
  const slDiff = entryPrice - stopPrice
...
export function formatTpLabel (stats: LongPositionStats, compact: boolean, precision: number): string {
  if (compact) {
